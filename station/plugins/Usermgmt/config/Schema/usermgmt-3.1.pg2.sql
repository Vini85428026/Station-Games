...
CREATE TABLE IF NOT EXISTS scheduled_emails (
  id SERIAL,
  user_email_id INT4 DEFAULT NULL,
  ...
  is_sent INT4 NOT NULL DEFAULT '0',
  scheduled_by INT4 DEFAULT NULL,
  created TIMESTAMP DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS scheduled_email_recipients (
  id SERIAL,
  scheduled_email_id INT4 NOT NULL,
  user_id INT4 DEFAULT NULL,
  email_address varchar(100) NOT NULL,
  is_email_sent INT4 NOT NULL DEFAULT '0',
  PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS users (
  ...
  email_verified INT4 NOT NULL DEFAULT '0',
  last_login TIMESTAMP DEFAULT NULL,
  ip_address varchar(50) DEFAULT NULL,
  created TIMESTAMP DEFAULT NULL,
  modified TIMESTAMP DEFAULT NULL,
  created_by INT4 DEFAULT NULL,
  modified_by INT4 DEFAULT NULL,
  PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS user_activities (
  ...
  user_id INT4 DEFAULT NULL,
  last_action INT4 NOT NULL,
  last_url text,
  user_browser text,
  ip_address varchar(50) DEFAULT NULL,
  logout INT4 NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS user_groups (
  ...
  name varchar(100)  DEFAULT NULL,
  description text ,
  registration_allowed INT4 NOT NULL DEFAULT '1',
  created TIMESTAMP DEFAULT NULL,
  modified TIMESTAMP DEFAULT NULL,
  PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS user_group_permissions (
  ...
  allowed INT4 NOT NULL DEFAULT '1',
  PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS user_setting_options (
  id SERIAL,
  user_setting_id INT4 NOT NULL,
  setting_option_id INT4 NOT NULL,
  created TIMESTAMP DEFAULT NULL,
  modified TIMESTAMP DEFAULT NULL,
  PRIMARY KEY (id)
